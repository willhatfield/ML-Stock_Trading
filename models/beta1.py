...
def main(stock_symbol):
    ...
    try:
        ...
        # For future predictions, we use the last available actual data
        future_predictions = predictor.predict_future(total_dataset.values, future_days=60)
        current_price = total_dataset.values[-1]
        plot_future_predictions(current_price, future_predictions, company)
